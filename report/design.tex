...
\todo{This will no longer be true after my newest changes.}

Importantly, this implementation does not protect task code. Tasks are able to execute any functions that they can be linked against. \todo{After my changes, process code will be protected.}

Task memory will be protected automatically upon task creation and heap allocation.

\todo{Stacks protected at task-level, heap protected at process-level.}
